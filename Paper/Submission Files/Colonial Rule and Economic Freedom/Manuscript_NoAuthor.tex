...
\input{Tables/Table1} % Sum Stats

\clearpage
\input{Tables/Table2} % List of Colonies
...
\clearpage
\input{Tables/Table3} % EFW_Colonizer

\clearpage
\input{Tables/Table4}  % Length: Base Sample

\clearpage
\input{Tables/Table5} % EFW_Colonizer: Late Independence Results

\clearpage
\input{Tables/Table6} % Length: Late Independence Results
...
\input{Tables/TableA1} % Sum Stats by Colonizer and Region

\input{Tables/TableA2} % Classification of Colonizer
...
\vspace{5cm}
\input{Tables/TableB1}

\clearpage
\input{Tables/TableB2}

\clearpage
\input{Tables/TableB3}

\clearpage
\input{Tables/TableB4}

\clearpage
\input{Tables/TableB5}

\clearpage
\input{Tables/TableB6}
